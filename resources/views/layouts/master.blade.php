            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- Manajemen Siswa -->
                        <li
                            class="nav-item has-treeview {{ Request::is('students*') || Request::is('attendances*') || Request::is('grades*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('students*') || Request::is('attendances*') || Request::is('grades*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('listStudents') }}"
                                        class="nav-link {{ Request::is('students') || Request::is('students/create') || Request::is('students/*/edit') ? 'active' : '' }}">
                                        <p>Kelola Profil Siswa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('listAttendances') }}"
                                        class="nav-link {{ Request::is('attendances*') ? 'active' : '' }}">
                                        <p>Kelola Kehadiran Siswa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('listGrades') }}"
                        ...
                        <!-- Manajemen Guru -->
                        <li
                            class="nav-item has-treeview {{ Request::is('teachers*') || Request::is('teaching_schedules*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('teachers*') || Request::is('teaching_schedules*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('listTeachers') }}"
                                        class="nav-link {{ Request::is('teachers*') ? 'active' : '' }}">
                                        <p>Kelola Profil Guru</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('listTeachingschedules') }}"
                                        class="nav-link {{ Request::is('teaching_schedules*') ? 'active' : '' }}">
